...
! Date:         Author:
!##################################################################################################
module ModCompressibleNeoHookeanBiphasic
    ...
    type , extends(ClassCompressibleNeoHookeanBiphasic) :: ClassCompressibleNeoHookeanBiphasic_3D
         ...
         contains
            ! Class Methods
            !----------------------------------------------------------------------------------
             procedure :: UpdateStressAndStateVariables  =>  UpdateStressAndStateVariables_CompressibleNeoHookeanB_3D
    ...
    type , extends(ClassCompressibleNeoHookeanBiphasic) :: ClassCompressibleNeoHookeanBiphasic_PlaneStrain
         ...
         contains
            ! Class Methods
            !----------------------------------------------------------------------------------
             procedure :: UpdateStressAndStateVariables  =>  UpdateStressAndStateVariables_CompressibleNeoHookeanB_PS
             procedure :: GetTangentModulus              =>  GetTangentModulus_CompressibleNeoHookeanBiphasic_PStrain
    ...
    contains
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine UpdateStressAndStateVariables_CompressibleNeoHookeanB_PS(this,Status)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine GetTangentModulus_CompressibleNeoHookeanBiphasic_PStrain(this,D)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine UpdateStressAndStateVariables_CompressibleNeoHookeanB_3D(this,Status)
