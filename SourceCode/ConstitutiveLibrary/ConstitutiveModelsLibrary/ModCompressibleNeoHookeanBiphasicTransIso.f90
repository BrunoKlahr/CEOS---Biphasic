...
! Date:         Author:
!##################################################################################################
module ModCompressibleNeoHookeanBiphasicTransIso
    ...
    type , extends(ClassConstitutiveModel) :: ClassCompressibleNeoHookeanBiphasicTransIso
        ...
        contains
            ...
            ! Class Methods
            !----------------------------------------------------------------------------------
             procedure :: ConstitutiveModelConstructor => ConstitutiveModelConstructor_CompressibleNeoHookeanBTI
             procedure :: ConstitutiveModelDestructor  => ConstitutiveModelDestructor_CompressibleNeoHookeanBTI
             procedure :: ReadMaterialParameters       => ReadMaterialParameters_CompressibleNeoHookeanBTI
             procedure :: GetResult                    => GetResult_CompressibleNeoHookeanBiphasicTransIso
             procedure :: SwitchConvergedState         => SwitchConvergedState_CompressibleNeoHookeanBiphasicTI
             procedure :: CopyProperties               => CopyProperties_CompressibleNeoHookeanBiphasicTransIso
             
             ! Fluid
            procedure :: GetPermeabilityTensor         => GetPermeabilityTensorCompressibleNeoHookeanBiphasicTI
    ...
    type , extends(ClassCompressibleNeoHookeanBiphasicTransIso) :: ClassCompressibleNeoHookeanBiphasicTransIso_3D
         ...
         contains
            ! Class Methods
            !----------------------------------------------------------------------------------
             procedure :: UpdateStressAndStateVariables  =>  UpdateStressAndStateVariables_CompressibleNeoHookeanBTI_3D
             procedure :: GetTangentModulus              =>  GetTangentModulus_CompressibleNeoHookeanBiphasicTI_3D
    ...
    type , extends(ClassCompressibleNeoHookeanBiphasicTransIso) :: ClassCompressibleNeoHookeanBiphasicTransIso_PlaneStrain
         ...
         contains
            ! Class Methods
            !----------------------------------------------------------------------------------
             procedure :: UpdateStressAndStateVariables  =>  UpdateStressAndStateVariables_CompressibleNeoHookeanBTI_PS
             procedure :: GetTangentModulus              =>  GetTangentModulus_CompressibleNeoHookeanBiphasicTI_PStrain
    ...
    contains
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine ConstitutiveModelConstructor_CompressibleNeoHookeanBTI(this,AnalysisSettings)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine ConstitutiveModelDestructor_CompressibleNeoHookeanBTI(this)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine ReadMaterialParameters_CompressibleNeoHookeanBTI(this,DataFile)
            ...
            ListOfOptions=["Mu","Lambda","ka", "kt", "Theta"]
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine CopyProperties_CompressibleNeoHookeanBiphasicTransIso(this,Reference)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine UpdateStressAndStateVariables_CompressibleNeoHookeanBTI_PS(this,Status)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine GetTangentModulus_CompressibleNeoHookeanBiphasicTI_PStrain(this,D)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine UpdateStressAndStateVariables_CompressibleNeoHookeanBTI_3D(this,Status)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine GetTangentModulus_CompressibleNeoHookeanBiphasicTI_3D(this,D)
        ...
        !==========================================================================================
        subroutine SwitchConvergedState_CompressibleNeoHookeanBiphasicTI(this)
            class(ClassCompressibleNeoHookeanBiphasicTransIso) :: this
        end subroutine
        !==========================================================================================

        !==========================================================================================
        subroutine GetResult_CompressibleNeoHookeanBiphasicTransIso(this, ID , Name , Length , Variable , VariableType  )
        ...
        !==========================================================================================
        subroutine GetPermeabilityTensorCompressibleNeoHookeanBiphasicTI(this,Kf)
            use MathRoutines
            ...
            !Thayller - Adicionado variaveis de permeabilidade axial, transversal e angulo da fibra
