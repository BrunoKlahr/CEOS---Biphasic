...
! Date:         Author:
!##################################################################################################
module ModNeoHookeanIsochoricBiphasic
    ...
    type , extends(ClassConstitutiveModel) :: ClassNeoHookeanIsochoricBiphasic
        ...
        contains
            ...
            ! Class Methods
            !----------------------------------------------------------------------------------
             procedure :: ConstitutiveModelConstructor => ConstitutiveModelConstructor_NeoHookeanIsochoricBiphasic
             procedure :: ConstitutiveModelDestructor  => ConstitutiveModelDestructor_NeoHookeanIsochoricBiphasic
             procedure :: ReadMaterialParameters       => ReadMaterialParameters_NeoHookeanIsochoricBiphasic
             procedure :: GetResult                    => GetResult_NeoHookeanIsochoricBiphasic
             procedure :: SwitchConvergedState         => SwitchConvergedState_NeoHookeanIsochoricBiphasic
             procedure :: CopyProperties               => CopyProperties_NeoHookeanIsochoricBiphasic

             procedure :: LoadPropertiesFromVector            => LoadPropertiesFromVector_NeoHookeanIsochoricB
             procedure :: LoadInternalVariablesFromVector     => LoadInternalVariablesFromVector_NeoHookeanIsochoricB
             procedure :: ExportInternalVariablesToVector     => ExportInternalVariablesToVector_NeoHookeanIsochoricB
             
            ! Fluid
            procedure :: GetPermeabilityTensor         => GetPermeabilityTensorNeoHookeanIsochoricBiphasic
    ...
    type , extends(ClassNeoHookeanIsochoricBiphasic) :: ClassNeoHookeanIsochoricBiphasic_PlaneStrain
         ...
         contains
            ! Class Methods
            !----------------------------------------------------------------------------------
             procedure :: UpdateStressAndStateVariables  =>  UpdateStressAndStateVariables_NeoHookeanIsochoricB_PlaneStrain
             procedure :: GetTangentModulus              =>  GetTangentModulus_NeoHookeanIsochoricB_PlaneStrain
    ...
    type , extends(ClassNeoHookeanIsochoricBiphasic) :: ClassNeoHookeanIsochoricBiphasic_3D
         ...
         contains
            ! Class Methods
            !----------------------------------------------------------------------------------
             procedure :: UpdateStressAndStateVariables  =>  UpdateStressAndStateVariables_NeoHookeanIsochoricBiphasic_3D
             procedure :: GetTangentModulus              =>  GetTangentModulus_NeoHookeanIsochoricBiphasic_3D
    ...
    contains
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine LoadPropertiesFromVector_NeoHookeanIsochoricB(this,Props)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine LoadInternalVariablesFromVector_NeoHookeanIsochoricB(this,IntVars)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine ExportInternalVariablesToVector_NeoHookeanIsochoricB(this,IntVars)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine ConstitutiveModelConstructor_NeoHookeanIsochoricBiphasic(this,AnalysisSettings)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine ConstitutiveModelDestructor_NeoHookeanIsochoricBiphasic(this)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine ReadMaterialParameters_NeoHookeanIsochoricBiphasic(this,DataFile)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine CopyProperties_NeoHookeanIsochoricBiphasic(this,Reference)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine UpdateStressAndStateVariables_NeoHookeanIsochoricB_PlaneStrain(this,Status)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine GetTangentModulus_NeoHookeanIsochoricB_PlaneStrain(this,D)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine UpdateStressAndStateVariables_NeoHookeanIsochoricBiphasic_3D(this,Status)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine GetTangentModulus_NeoHookeanIsochoricBiphasic_3D(this,D)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine SwitchConvergedState_NeoHookeanIsochoricBiphasic(this)
            class(ClassNeoHookeanIsochoricBiphasic) :: this
        end subroutine
        !==========================================================================================
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine GetResult_NeoHookeanIsochoricBiphasic(this, ID , Name , Length , Variable , VariableType  )
        ...
        !==========================================================================================
        subroutine GetPermeabilityTensorNeoHookeanIsochoricBiphasic(this,Kf)
            use MathRoutines
