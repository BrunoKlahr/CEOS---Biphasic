...
! Date:         Author:
!##################################################################################################
module ModNeoHookeanIsochoricBiphasicTransIso
    ...
    type , extends(ClassConstitutiveModel) :: ClassNeoHookeanIsochoricBiphasicTransIso
        ...
        contains
            ...
            ! Class Methods
            !----------------------------------------------------------------------------------
             procedure :: ConstitutiveModelConstructor => ConstitutiveModelConstructor_NeoHookeanIsochoricBiphasicTI
             procedure :: ConstitutiveModelDestructor  => ConstitutiveModelDestructor_NeoHookeanIsochoricBiphasicTI
             procedure :: ReadMaterialParameters       => ReadMaterialParameters_NeoHookeanIsochoricBiphasicTransIso
             procedure :: GetResult                    => GetResult_NeoHookeanIsochoricBiphasicTransIso
             procedure :: SwitchConvergedState         => SwitchConvergedState_NeoHookeanIsochoricBiphasicTransIso
             procedure :: CopyProperties               => CopyProperties_NeoHookeanIsochoricBiphasicTransIso

             procedure :: LoadPropertiesFromVector            => LoadPropertiesFromVector_NeoHookeanIsochoricBTI
             procedure :: LoadInternalVariablesFromVector     => LoadInternalVariablesFromVector_NeoHookeanIsochoricBTI
             procedure :: ExportInternalVariablesToVector     => ExportInternalVariablesToVector_NeoHookeanIsochoricBTI
             
            ! Fluid
            procedure :: GetPermeabilityTensor         => GetPermeabilityTensorNeoHookeanIsochoricBiphasicTransIso
    ...
    type , extends(ClassNeoHookeanIsochoricBiphasicTransIso) :: ClassNeoHookeanIsochoricBiphasicTI_PStrain
         ...
         contains
            ! Class Methods
            !----------------------------------------------------------------------------------
             procedure :: UpdateStressAndStateVariables  =>  UpdateStressAndStateVariables_NeoHookeanIsochoricBTI_PStrain
             procedure :: GetTangentModulus              =>  GetTangentModulus_NeoHookeanIsochoricBTI_PStrain
    ...
    type , extends(ClassNeoHookeanIsochoricBiphasicTransIso) :: ClassNeoHookeanIsochoricBiphasicTI_3D
         ...
         contains
            ! Class Methods
            !----------------------------------------------------------------------------------
             procedure :: UpdateStressAndStateVariables  =>  UpdateStressAndStateVariables_NeoHookeanIsochoricBiphasicTI_3D
             procedure :: GetTangentModulus              =>  GetTangentModulus_NeoHookeanIsochoricBiphasicTransIso_3D
    ...
    contains
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine LoadPropertiesFromVector_NeoHookeanIsochoricBTI(this,Props)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine LoadInternalVariablesFromVector_NeoHookeanIsochoricBTI(this,IntVars)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine ExportInternalVariablesToVector_NeoHookeanIsochoricBTI(this,IntVars)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine ConstitutiveModelConstructor_NeoHookeanIsochoricBiphasicTI(this,AnalysisSettings)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine ConstitutiveModelDestructor_NeoHookeanIsochoricBiphasicTI(this)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine ReadMaterialParameters_NeoHookeanIsochoricBiphasicTransIso(this,DataFile)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine CopyProperties_NeoHookeanIsochoricBiphasicTransIso(this,Reference)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine UpdateStressAndStateVariables_NeoHookeanIsochoricBTI_PStrain(this,Status)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine GetTangentModulus_NeoHookeanIsochoricBTI_PStrain(this,D)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine UpdateStressAndStateVariables_NeoHookeanIsochoricBiphasicTI_3D(this,Status)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine GetTangentModulus_NeoHookeanIsochoricBiphasicTransIso_3D(this,D)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine SwitchConvergedState_NeoHookeanIsochoricBiphasicTransIso(this)
            class(ClassNeoHookeanIsochoricBiphasicTransIso) :: this
        end subroutine
        !==========================================================================================
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine GetResult_NeoHookeanIsochoricBiphasicTransIso(this, ID , Name , Length , Variable , VariableType  )
        ...
        !==========================================================================================
        subroutine GetPermeabilityTensorNeoHookeanIsochoricBiphasicTransIso(this,Kf)
            use MathRoutines
