...
! Date:         Author:
!##################################################################################################
module ModStVenantKirchhoffBiphasic
	...
	!XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
    type StVenantKirchhoffBiphasicProperties

        ! Variables of material parameters
        !----------------------------------------------------------------------------------------------
        real(8) :: Poisson , YoungModulus, Lambda, Mu, k0
    ...
    ! Class"NameOfTheMaterialModel": Attributes and methods of the constitutive model
	!XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
    type , extends(ClassConstitutiveModel) :: ClassStVenantKirchhoffBiphasic

		! Class Attributes : Usually the state variables (instant and internal variables)
		!----------------------------------------------------------------------------------------
         type (StVenantKirchhoffBiphasicProperties), pointer :: Properties => null()

        contains

            ! Class Methods
            !----------------------------------------------------------------------------------
             procedure :: ConstitutiveModelConstructor => ConstitutiveModelConstructor_StVenantKirchhoffBiphasic
             procedure :: ConstitutiveModelDestructor  => ConstitutiveModelDestructor_StVenantKirchhoffBiphasic
             procedure :: ReadMaterialParameters       => ReadMaterialParameters_StVenantKirchhoffBiphasic
             procedure :: GetResult                    => GetResult_StVenantKirchhoffBiphasic
             procedure :: SwitchConvergedState         => SwitchConvergedState_StVenantKirchhoffBiphasic
             procedure :: CopyProperties               => CopyProperties_StVenantKirchhoffBiphasic
             
             
            ! Fluid
            procedure :: GetPermeabilityTensor         => GetPermeabilityTensorStVenantKirchhoffBiphasic
	...
	!XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
    type , extends(ClassStVenantKirchhoffBiphasic) :: ClassStVenantKirchhoffBiphasic_PlaneStrain
         ...
         contains
            ...
            !----------------------------------------------------------------------------------
             ...
             procedure :: UpdateStressAndStateVariables  =>  UpdateStressAndStateVariables_StVenantKirchhoffB_PlaneStrain
             procedure :: GetTangentModulus              =>  GetTangentModulus_StVenantKirchhoffBiphasic_PlaneStrain
    ...
    ! in Plane Strain analysis.
	!XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
    type , extends(ClassStVenantKirchhoffBiphasic) :: ClassStVenantKirchhoffBiphasic_Axisymmetric
         ...
         contains
            ...
            !----------------------------------------------------------------------------------
             ...
             procedure :: UpdateStressAndStateVariables  =>  UpdateStressAndStateVariables_StVenantKirchhoffB_Axisymmetric
             procedure :: GetTangentModulus              =>  GetTangentModulus_StVenantKirchhoffBiphasic_Axisymmetric
	...
	!XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
    type , extends(ClassStVenantKirchhoffBiphasic) :: ClassStVenantKirchhoffBiphasic_3D

         contains
            ! Class Methods
            !----------------------------------------------------------------------------------
             procedure :: UpdateStressAndStateVariables  =>  UpdateStressAndStateVariables_StVenantKirchhoffBiphasic_3D
             procedure :: GetTangentModulus              =>  GetTangentModulus_StVenantKirchhoffBiphasic_3D
    ...
    contains
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine ConstitutiveModelConstructor_StVenantKirchhoffBiphasic(this,AnalysisSettings)
            ...
            ! Object
            ! -----------------------------------------------------------------------------------
            class(ClassStVenantKirchhoffBiphasic) :: this
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine ConstitutiveModelDestructor_StVenantKirchhoffBiphasic(this)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine ReadMaterialParameters_StVenantKirchhoffBiphasic(this,DataFile)
            use Parser
            ...
            ListOfOptions=["YoungModulus","Poisson","k0"]
            ...
            do i=1,size(FoundOption)
                if (.not.FoundOption(i)) then
                    write(*,*) "ReadMaterialParameters_LinearElasticBiphasic :: Option not found ["//trim(ListOfOptions(i))//"]"
                    stop
                endif
            enddo
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine CopyProperties_StVenantKirchhoffBiphasic(this,Reference)
             ...
             select type ( Reference )
                 ...
                 class is ( ClassStVenantKirchhoffBiphasic )
                    this%Properties => Reference%Properties
                 class default
                     stop "erro na subroutine CopyProperties_StVenantKirchhoffBiphasic"
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine UpdateStressAndStateVariables_StVenantKirchhoffB_PlaneStrain(this,Status)
            ...
            class(ClassStVenantKirchhoffBiphasic_PlaneStrain) :: this
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine GetTangentModulus_StVenantKirchhoffBiphasic_PlaneStrain(this,D)
            ...
            class (StVenantKirchhoffBiphasicProperties), pointer :: p
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine UpdateStressAndStateVariables_StVenantKirchhoffB_Axisymmetric(this,Status)
            ...
            class(ClassStVenantKirchhoffBiphasic_Axisymmetric) :: this
            type(ClassStatus) :: Status
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine GetTangentModulus_StVenantKirchhoffBiphasic_Axisymmetric(this,D)
...
!            D = Daxi
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine UpdateStressAndStateVariables_StVenantKirchhoffBiphasic_3D(this,Status)
            ...
            class(ClassStVenantKirchhoffBiphasic_3D) :: this
            type(ClassStatus) :: Status
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine GetTangentModulus_StVenantKirchhoffBiphasic_3D(this,D)
        ...
        function Cs(b,p,detF,i,j,k,l) result(x)
            ...
            class (StVenantKirchhoffBiphasicProperties) :: p
            integer :: i,j,k,l
            real(8) :: b(3,3), detF, x
        ...
        !==========================================================================================
        subroutine SwitchConvergedState_StVenantKirchhoffBiphasic(this)
            class(ClassStVenantKirchhoffBiphasic) :: this
        end subroutine
        !==========================================================================================
        ...
        !==========================================================================================
        subroutine GetResult_StVenantKirchhoffBiphasic( this, ID , Name , Length , Variable , VariableType )
        ...
        !==========================================================================================
        subroutine GetPermeabilityTensorStVenantKirchhoffBiphasic(this,Kf)
            use MathRoutines
