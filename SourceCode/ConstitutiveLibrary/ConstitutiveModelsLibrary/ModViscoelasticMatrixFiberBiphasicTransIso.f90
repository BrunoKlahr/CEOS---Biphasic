...
! Date:         Author:
!##################################################################################################
module ModViscoelasticMatrixFiberBiphasicTransIso
    ...
    type , extends(ClassConstitutiveModel) :: ClassViscoelasticMatrixFiberBiphasicTransIso
        ...
        contains
            ...
            ! Class Methods
            !----------------------------------------------------------------------------------
             procedure :: ConstitutiveModelConstructor => ConstitutiveModelConstructor_ViscoelasticMatrixFiberBTI
             procedure :: ConstitutiveModelDestructor  => ConstitutiveModelDestructor_ViscoelasticMatrixFiberBTI
             procedure :: ReadMaterialParameters       => ReadMaterialParameters_ViscoelasticMatrixFiberBTI
             procedure :: GetResult                    => GetResult_ViscoelasticMatrixFiberBiphasicTransIso
             procedure :: SwitchConvergedState         => SwitchConvergedState_ViscoelasticMatrixFiberBiphasicTransIso
             procedure :: CopyProperties               => CopyProperties_ViscoelasticMatrixFiberBiphasicTransIso

             procedure :: LoadPropertiesFromVector            => LoadPropertiesFromVector_ViscoelasticMatrixFiberBTI
             procedure :: LoadInternalVariablesFromVector     => LoadInternalVariablesFromVector_ViscoelasticMatrixFiberBTI
             procedure :: ExportInternalVariablesToVector     => ExportInternalVariablesToVector_ViscoelasticMatrixFiberBTI
             
            ! Fluid
            procedure :: GetPermeabilityTensor         => GetPermeabilityTensorViscoelasticMatrixFiberBiphasicTransIso
    ...
    type , extends(ClassViscoelasticMatrixFiberBiphasicTransIso) :: ClassViscoelasticMatrixFiberBiphasicTransIso_3D
         ...
         contains
            ! Class Methods
            !----------------------------------------------------------------------------------
             procedure :: UpdateStressAndStateVariables  =>  UpdateStressAndStateVariables_ViscoelasticMatrixFiberBTI_3D
             procedure :: GetTangentModulus              =>  GetTangentModulus_ViscoelasticMatrixFiberBTI_3D
    ...
    contains
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine LoadPropertiesFromVector_ViscoelasticMatrixFiberBTI(this,Props)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine LoadInternalVariablesFromVector_ViscoelasticMatrixFiberBTI(this,IntVars)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine ExportInternalVariablesToVector_ViscoelasticMatrixFiberBTI(this,IntVars)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine ConstitutiveModelConstructor_ViscoelasticMatrixFiberBTI(this,AnalysisSettings)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine ConstitutiveModelDestructor_ViscoelasticMatrixFiberBTI(this)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine ReadMaterialParameters_ViscoelasticMatrixFiberBTI(this,DataFile)
            use Parser
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine CopyProperties_ViscoelasticMatrixFiberBiphasicTransIso(this,Reference)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine UpdateStressAndStateVariables_ViscoelasticMatrixFiberBTI_3D(this,Status)
        ...
        ! Date:         Author:
        !==========================================================================================
        subroutine GetTangentModulus_ViscoelasticMatrixFiberBTI_3D(this,D)
        ...
        !==========================================================================================
        subroutine SwitchConvergedState_ViscoelasticMatrixFiberBiphasicTransIso(this)
        ...
        !==========================================================================================
        subroutine GetResult_ViscoelasticMatrixFiberBiphasicTransIso(this, ID , Name , Length , Variable , VariableType  )
        ...
        !==========================================================================================
         ...
         !==========================================================================================
        subroutine GetPermeabilityTensorViscoelasticMatrixFiberBiphasicTransIso(this,Kf)
            use MathRoutines
