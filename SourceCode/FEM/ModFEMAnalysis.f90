        ...
        subroutine  SolveFEMAnalysis( this )
            ...
            select case ( this%AnalysisSettings%AnalysisType )
                ...
                case ( AnalysisTypes%Quasi_Static )
                    ...
                    if (this%AnalysisSettings%ProblemType .eq. ProblemTypes%Mechanical) then
                    ...
                    !elseif (this%AnalysisSettings%ProblemType .eq. ProblemTypes%Biphasic) then
                               
                               !call this%AdditionalMaterialModelRoutine()

                               !call QuasiStaticAnalysisFEM_biphasic( this%ElementList, this%AnalysisSettings, this%GlobalNodesList , &
                                                 !this%GlobalNodesList, this%BC, this%BC, this%Kg, this%KgFluid, this%NLSolver )
                    endif
...
! TODO (Thiago#1#): Passar os enumeradores dos modelos para realizar as contas somente nos elementos que possuem o devido modelo material.
    ...
    if ( n .eq. 1234123312 ) then
         ...
         ! Parâmetros da Hélice
            ...
            ElemRef = 37!77      !16308  !1          !211 !166 !45271 !15226 !4401     !2 Fibras: 1776  !12 Fibras: 4526       !1 fibra de 3 voltas: 1501
            NodeRef = 23!1334    !19670  !75         !1064 !110 !289 !5150 !2088     !2 Fibras: 2868  !12 Fibras: 5950       !1 fibra de 3 voltas: 31
